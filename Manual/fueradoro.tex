...
\item Der \texttt{Brauerei Löscher} für Club Mate den Bastler-Treibstoff
...
Transmitterbox und Zündbox sind in Abbildung \ref{fig:senderadapter} bzw. \ref{fig:zuendbox} mit ihren wesentlichen Bestandteilen gezeigt. Sie werden im weiteren Text unter dem Begriff \enquote{Devices} zusammengefasst, falls sich Aussagen auf beide Teile beziehen, und in den folgenden Kapiteln näher beschrieben. 
...
Die aktuelle Firmware kann aus dem SVN-Repository
\begin{center}\url{http://el-fueradoro.googlecode.com/svn/trunk/}\end{center}
...
\begin{figure}
\centering
\includegraphics[angle=-90, width=.95\textwidth]{Bilder/Transmitterschaltplan}
...
\begin{figure}
\centering
\includegraphics[angle=90, height=\textheight]{Bilder/Zuendboxschaltplan}
...
\begin{figure}
\centering
\includegraphics[angle=90, width=\textwidth]{Bilder/Transmitterlayout}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{Bilder/Zuendboxlayout}
...
dht.c & Steuerung der Temperatursensoren \texttt{DHT22} oder \texttt{DHT11} (obsolet)\\
...
R12, R14, R38 & 1 & 3k3 & Reichelt & METALL 3,30K & \EUR{0,08} & \EUR{0,08} & \\
R15 & 1 & 56k & Reichelt & METALL 56K & \EUR{0,08} & \EUR{0,08} & \\
R21{\dots}36 & 18 & 6k8 & Reichelt & 1/4W 6,8K & \EUR{0,03} & \EUR{0,59} & \\
...
Ausgangspunkt der Bestückung ist die geätzte und gebohrte Platine mit allen Leiterbahnen auf der Ober- und Unterseite. Anschließend sollten die Bauteile in folgender Reihenfolge eingelötet werden:
\begin{description}
