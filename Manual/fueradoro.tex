...
\begin{titlepage}
	...
	\begin{center}{\fontsize{64pt}{64pt} \Driftwood{\anlage}} \\ \vspace{2em}
...
\part{Benutzerhandbuch}
	...
	\chapter{raspEasyFire}
		...
		Neben einem Raspberry Pi werden für den Aufbau eine speziell für die Verwendung mit {\anlage} entwickelte Aufsteckplatine sowie ein Touchdisplay, eine USB-Soundkarte, zwei Taster (FIRE und ON-OFF), ein Schlüsselschalter und zwei LEDs benötigt. Eine Einkaufsliste findet sich in Tabelle~\ref{tab:raspibom} ab Seite \pageref{tab:raspibom}.

		Ausgangspunkt für die Arbeiten mit {\REF} ist ein komplett aufgebautes System mit beschriebener SD-Karte, die notwendigen Schritte hierzu werden in den Abschnitten~\ref{sec:raspipcb}, \ref{subsec:raspicase} und \ref{ch:raspisd} dargelegt.
		...
		\section{Konfiguration}
			...
			\end{center}
			erfolgen, wobei \enquote{DATEINAME} durch \enquote{aesvalues.txt} oder \enquote{raspEasyFire.conf} zu ersetzen ist.
		...
		Durch Drücken des FIRE-Buttons nach dem Hochfahren, startet die Benutzeroberfläche von {\REF}. 
		
		\subsection{Automatische Checks vor Showbeginn}
			...
			Es empfiehlt sich, mit großem Zeitpuffer vor Beginn der Show einen Trockenlauf zu machen, um auf Fehler, die vor Ort nicht mehr allzu leich zu beheben sind, aufmerksam zu werden.
			
			Sind alle Bedingungen erfüllt, beginnt die FIRE-Button-LED nach dem Scharfschalten zu blinken und ein Druck auf den FIRE-Button startet die Show.
