...
\begin{document}
	...
	\part{Benutzerhandbuch}
		...
		\chapter{Der Raspberry-Pi-Transmitter}
			...
			Als Alternative zur Kombination aus Laptop/PC und dem in den vorangegangenen Abschnitten beschriebenen Transmitter wurde ein Audio-Funksystem auf Basis des bekannten Einplatinencomputers Raspberry Pi entwickelt. Dieser übernimmt die Kontrolle der Show inklusive der Musikwiedergabe.

			Neben einem Raspberry Pi werden für den Aufbau eine speziell für die Verwendung mit {\anlage} entwickelte Aufsteckplatine sowie ein Touchdisplay, eine USB-Soundkarte, zwei Taster, ein Schlüsselschalter und zwei LEDs benötigt. Eine Einkaufsliste findet sich im letzten Teil dieser Datei ab Seite \pageref{part:aufbauanleitung}.
		...
		\chapter{Firmwareupdate}
			...
			\section{Aktualisierung}
				...
				Da zu Beginn der Entwicklung von {\anlage} auch noch ein Vorgänger des \emph{ATmega328P} verwendet wurde, existiert auch hierfür noch eine Firmwareversion, zusätzlich gibt es auch noch eine \enquote{High Power}-Firmware, welche die Sendeleistung des Funkmoduls standardmäßig auf den Maximalwert setzt, so dass sich drei verschiedene Firmwaredateien gemäß Tabelle~\ref{tab:firmwareversions} im gleichen Ordner wie \emph{fwupdate.exe} und \emph{UpdateLoader.exe} befinden.
				...
				\begin{table}
					...
					\begin{tabularx}{.925\textwidth}{Xccc}
						...
						Pyro\_atmega168p\_RFM69.hex     & ATMEGA 168PA & RFM69CW   & $\SI{8}{\dBm}$  \\ \hline\hline
					\end{tabularx}
	...
	\part{Dokumentation}
		...
		\chapter{Pinbelegung}
			...
			\section{Raspberry-Pi-Aufsteckplatine}
				...
				Die 40-polige Buchsenleiste ist zeigt dabei in die Papierebene hinein, die Klemmen an der Seite aus der Papierebene heraus.
	...
	\part{Aufbauanleitung}
		...
		\chapter{Aufbau}
			...
			\section{Raspberry-Pi-Transmitter}
