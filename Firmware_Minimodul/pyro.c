...
int main( void ) {
    ...
    uint16_t debounce_reed_state = 0xAAAA, debounce_arm_state = 0xAAAA, debounce_test_state = 0xAAAA;
    ...
    uint16_t         *debounce_state[ DEBOUNCE_DEVS ]     = { &debounce_reed_state, &debounce_arm_state, &debounce_test_state };
    ...
    const uint8_t     debounce_minCycles[ DEBOUNCE_DEVS ] = { 25, 50, 25 };
