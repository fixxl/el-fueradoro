...
#define   waitRx( XX )    for ( uint8_t i = rx_field[rx_length - 1] - 1; i; i-- ) _delay_us ( ( ADDITIONAL_LENGTH + ((XX ## _LENGTH)/16 + 1 * (((XX ## _LENGTH)%16) && 1)) * 16 ) * BYTE_DURATION_US + (500000/BITRATE + 1) + 5 + (5*RFM_RAMP_UP/4))
